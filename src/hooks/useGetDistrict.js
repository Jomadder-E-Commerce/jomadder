...
import { division } from './useGetDivision';
...
const useGetDistrict = (divisionProp) => {
    ...
    const getDistrictsByDivision = (divisionId) => {
      const data = [...allDistricts].filter(district => district.division_id === divisionId);
      setNeedDistricts(data);
      console.log(data)
    };
